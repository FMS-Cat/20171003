...
let framebufferPost = glCat.createFloatFramebuffer( width / 2.0, height / 2.0 );
...
let update = () => {
  if ( frame % frames === 0 ) { xorshift( 3248557111327 ); }
  ...
  cameraPos = [
    3.0 * Math.cos( 2.0 * Math.PI * time ),
    0.0,
    3.0 * Math.sin( 2.0 * Math.PI * time )
  ];
